            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 container-left">
                ...
                <form class="row formulario" method="POST" enctype="multipart/form-data" action="formularios/cadastro_animal.php">
                    <div class="col-lg-6 col-sm-12">
                        ...
                        <div class="input-field">
                            <div class="row"><label>Descrição: </label></div>
                            <div class="row">
                                <textarea name="descricao" cols="19" rows="2" placeholder="Digite a descrição do animal: "></textarea>
                            </div>
                        </div>
                        <div class="input-field">
                    ...
                    <div class="col-lg-6 col-sm-12">
                        ...
                        <div class="input-field">
                            <div class="row"><label>Informações médicas: </label></div>
                            <div class="row">
                                <input type="text" name="info_medicas" id="campo_info_animal" class="campos" placeholder="Digite as informações do animal: ">
                            </div>
                        </div>
                        <div class="input-field">
                            <div class="row"><label>Contato responsável: </label></div>
                            <div class="row">
                                <input type="tel" name="contato_resp" id="campo_contato_animal" class="campos" placeholder="Digite o número de celular: " maxlength="11">
                            </div>
                        </div>
                        <div class="input-field">
                            <div class="row"><label>Raça: </label></div>
                            <div class="row">
                                <select name="raca">
                                    ...
                                    <option value="Gato Siamês">Gato Siamês</option>
